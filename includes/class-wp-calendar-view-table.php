...
/**
 * Base Class for building a Calendar view.
 *
 ...
 * @author  Gary Jones <gary@garyjones.co.uk>
 */
class WP_Calendar_View_Table extends WP_Calendar_View {
	 ...
	 * @since 0.1.0
	 *
	 * @uses WP_Calendar_View_Table::build_caption() Table caption.
	 * @uses WP_Calendar_View_Table::build_head() Table head.
	 * @uses WP_Calendar_View_Table::build_caption() Table foot.
	 * @uses WP_Calendar_View_Table::build_caption() Table body.
	 *
